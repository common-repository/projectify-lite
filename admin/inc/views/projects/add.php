    ...
    <div class="subheader py-2 py-lg-6 subheader-transparent" id="btpjy_subheader">
        <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                <!--begin::Title-->
                <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5"><?php esc_html_e( 'New Project', 'projectify' ); ?></h5>
                <!--end::Title-->
                <!--begin::Separator-->
                ...
                <div class="d-flex align-items-center" id="btpjy_subheader_search">
                    <span class="text-dark-50 font-weight-bold" id="btpjy_subheader_total"><?php esc_html_e( 'Enter project details and submit', 'projectify' ); ?></span>
                </div>
                <!--end::Search Form-->
            </div>
            <!--end::Details-->
                                ...
                                <div class="wizard-step" id="wizard-step-two" data-wizard-type="step" data-wizard-state="pending">
                                    <div class="wizard-wrapper">
                                        ...
                                        <div class="wizard-label">
                                            ...
                                            <div class="wizard-desc"><?php esc_html_e( 'Team & Client details', 'projectify' ); ?></div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card-body p-0">
                                <div class="row justify-content-center py-8 px-8 py-lg-15 px-lg-10">
                                    <div class="col-xl-12 col-xxl-10">
                                        <!--begin::Wizard Form-->
                                        <form class="form fv-plugins-bootstrap fv-plugins-framework" id="AddProjectsForm" method="post" action="<?php echo esc_url( admin_url( 'admin-ajax.php' ) ); ?>">
                                            <?php $nonce = wp_create_nonce( 'btpjy_save_projects' ); ?>
                                            <input type="hidden" name="btpjy_save_projects_nounce" value="<?php echo esc_attr( $nonce ); ?>">
                                            <input type="hidden" name="action" value="btpjy_save_projects_action">
                                            <div class="row justify-content-center">
                                                <div class="col-xl-9">
                                                    ...
                                                    <div class="my-5 step" id="member-fields-panel-one" data-wizard-type="step-content" data-wizard-state="current">
                                                        ...
                                                        <div class="form-group row fv-plugins-icon-container">
                                                            ...
                                                            <div class="col-lg-9 col-xl-9">
                                                                <input class="form-control form-control-solid form-control-lg" id="title" name="title" type="text" placeholder="<?php esc_attr_e( 'Enter project title', 'projectify' ); ?>">
                                                        ...
                                                        <div class="form-group row fv-plugins-icon-container">
                                                            ...
                                                            <div class="col-lg-9 col-xl-9">
                                                                <textarea class="form-control form-control-solid form-control-lg" rows="10" id="description" name="description"></textarea>
                                                        ...
                                                        <div class="form-group row fv-plugins-icon-container">
                                                            ...
                                                            <div class="col-lg-9 col-xl-9">
                                                                <textarea class="form-control form-control-solid form-control-lg" rows="5" name="sdescription"></textarea>
                                                            <div class="fv-plugins-message-container"></div></div>
                                                        </div>
                                                        <!--end::Group-->
                                                        <!--begin::Group-->
                                                        <div class="form-group row fv-plugins-icon-container">
                                                            ...
                                                            <div class="col-lg-9 col-xl-9">
                                                                <input class="form-control form-control-solid form-control-lg" name="starting_date" id="starting_date" type="text" placeholder="<?php esc_attr_e( '', 'projectify' ); ?>">
                                                            <div class="fv-plugins-message-container"></div></div>
                                                        </div>
                                                        <!--end::Group-->
                                                        <!--begin::Group-->
                                                        <div class="form-group row fv-plugins-icon-container">
                                                            ...
                                                            <div class="col-lg-9 col-xl-9">
                                                                <input class="form-control form-control-solid form-control-lg" name="due_date" id="due_date" type="text" placeholder="<?php esc_attr_e( '', 'projectify' ); ?>">
                                                            <div class="fv-plugins-message-container"></div></div>
                                                        </div>
                                                        <!--end::Group-->
                                                        <!--begin::Group-->
                                                        <div class="form-group row fv-plugins-icon-container">
                                                            ...
                                                            <div class="col-lg-9 col-xl-9">
                                                                <input class="form-control form-control-solid form-control-lg" id="deposit_amnt" name="deposit_amnt" type="number" placeholder="<?php esc_attr_e( '', 'projectify' ); ?>">
                                                            <div class="fv-plugins-message-container"></div></div>
                                                        </div>
                                                        <!--end::Group-->
                                                        <!--begin::Group-->
                                                        <div class="form-group row fv-plugins-icon-container">
                                                            ...
                                                            <div class="col-lg-9 col-xl-9">
                                                                <select class="form-control form-control-lg form-control-solid selectpicker" data-live-search="true" name="status">
                                                                    <option value="no-progress"><?php esc_html_e( 'No Progress', 'projectify' ); ?></option>
                                                    ...
                                                    <div class="my-5 step" id="member-fields-panel-two" data-wizard-type="step-content" data-wizard-state="">
                                                        <h5 class="text-dark font-weight-bold mb-10 mt-5"><?php esc_html_e( 'Team & Client Details', 'projectify' ); ?></h5>
                                                        <!--begin::Group-->
                                                        <div class="form-group row fv-plugins-icon-container">
                                                    ...
                                                    <div class="my-5 step" id="member-fields-panel-three" data-wizard-type="step-content" data-wizard-state="">
                                                        ...
                                                        <div class="form-group row fv-plugins-icon-container">
                                                            ...
                                                            <div class="col-xl-9 col-lg-9 col-form-label">
                                                                <div class="checkbox-inline">
                                                                    ...
                                                                    <input name="alerts[]" value="email" type="checkbox" checked>
                                                        ...
                                                        <div class="form-group row fv-plugins-icon-container">
                                                            ...
                                                            <div class="col-xl-9 col-lg-9 col-form-label">
                                                                <div class="checkbox-inline">
                                                                    <label class="checkbox checkbox-success">
                                                                    <input name="notify[]" value="admin" type="checkbox" checked>
                                                                    <span></span><?php esc_html_e( 'Admin', 'projectify' ); ?></label>
                                                                    <label class="checkbox checkbox-success">
                                                                    <input name="notify[]" value="client" type="checkbox" checked>
                                                                    <span></span><?php esc_html_e( 'Client', 'projectify' ); ?></label>
                                                                    <label class="checkbox checkbox-success">
                                                                    <input name="notify[]" value="team" type="checkbox" checked>
                                                        ...
                                                        <div class="form-group row fv-plugins-icon-container">
                                                            ...
                                                            <div class="col-xl-9 col-lg-9 col-form-label">
                                                                <div class="checkbox-inline">
                                                                    <label class="checkbox checkbox-success">
                                                                    <input name="comments[]" value="admin" type="checkbox" checked>
                                                                    <span></span><?php esc_html_e( 'Admin', 'projectify' ); ?></label>
                                                                    <label class="checkbox checkbox-success">
                                                                    <input name="comments[]" value="client" type="checkbox" checked>
                                                                    <span></span><?php esc_html_e( 'Client', 'projectify' ); ?></label>
                                                                    <label class="checkbox checkbox-success">
                                                                    <input name="comments[]" value="task" type="checkbox" checked>
                                                                    <span></span><?php esc_html_e( 'Team', 'projectify' ); ?></label>
                                                                </div>
                                                            <div class="fv-plugins-message-container"></div></div>
                                                        </div>
                                                    ...
                                                    <div class="my-5 step" id="member-fields-panel-four" data-wizard-type="step-content" data-wizard-state="">
                                                        ...
                                                        <div class="d-flex justify-content-between border-top pt-10 mt-15">
                                                            ...
                                                            <div>
                                                                <button type="submit" class="btn btn-success font-weight-bolder px-10 py-3" id="AddProjectsBtn"><?php esc_html_e( 'Submit', 'projectify' ); ?>
                                                                <span class="svg-icon svg-icon-md ml-3">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                                            <polygon points="0 0 24 0 24 24 0 24"></polygon>
