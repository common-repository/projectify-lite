...
$departments  = $wpdb->get_results( "SELECT * FROM $table" );
    ...
    <div class="subheader py-2 py-lg-6 subheader-transparent" id="btpjy_subheader">
        <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                <!--begin::Title-->
                <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5"><?php esc_html_e( 'New User', 'projectify' ); ?></h5>
                <!--end::Title-->
                <!--begin::Separator-->
                ...
                <div class="d-flex align-items-center" id="btpjy_subheader_search">
                    <span class="text-dark-50 font-weight-bold" id="btpjy_subheader_total"><?php esc_html_e( 'Enter user details and submit', 'projectify' ); ?></span>
                </div>
                <!--end::Search Form-->
            </div>
            <!--end::Details-->
                                ...
                                <div class="wizard-step" id="wizard-step-three" data-wizard-type="step" data-wizard-state="pending">
                                    <div class="wizard-wrapper">
                                        ...
                                        <div class="wizard-label">
                                            ...
                                            <div class="wizard-desc"><?php esc_html_e( 'User\'s Address', 'projectify' ); ?></div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card-body p-0">
                                <div class="row justify-content-center py-8 px-8 py-lg-15 px-lg-10">
                                    <div class="col-xl-12 col-xxl-10">
                                        <!--begin::Wizard Form-->
                                        <form class="form fv-plugins-bootstrap fv-plugins-framework" id="AddMembersForm" method="post" action="<?php echo esc_url( admin_url( 'admin-ajax.php' ) ); ?>">
                                            <?php $nonce = wp_create_nonce( 'btpjy_save_members' ); ?>
                                            <input type="hidden" name="btpjy_save_members_nounce" value="<?php echo esc_attr( $nonce ); ?>">
                                            <input type="hidden" name="action" value="btpjy_save_members_action">
                                                ...
                                                <div class="col-xl-9">
                                                    ...
                                                    <div class="my-5 step" id="member-fields-panel-one" data-wizard-type="step-content" data-wizard-state="current">
                                                        ...
                                                        <div class="form-group row fv-plugins-icon-container">
                                                            <label class="col-form-label col-xl-3 col-lg-3"><?php esc_html_e( 'Entry', 'projectify' ); ?></label>
                                                            <div class="col-xl-9 col-lg-9">
                                                                <select class="form-control form-control-lg form-control-solid selectpicker" data-live-search="true" name="entry" id="entry">
                                                                    <option value="exist"><?php esc_html_e( 'Existing user', 'projectify' ); ?></option>
                                                                    <option value="new"><?php esc_html_e( 'Create new user', 'projectify' ); ?></option>
                                                                </select>
                                                        ...
                                                        <!--begin::Group-->
                                                        <div class="form-group row fv-plugins-icon-container" id="select-member-div">
                                                            <label class="col-form-label col-xl-3 col-lg-3"><?php esc_html_e( 'User', 'projectify' ); ?></label>
                                                            <div class="col-xl-9 col-lg-9">
                                                                <?php $users_list = btpjy_Helper::btpjy_get_users_list(); ?>
                                                                <select class="form-control form-control-lg form-control-solid selectpicker" data-live-search="true" name="user_id" id="user_id">
                                                                    <option value=""><?php esc_html_e( 'Select User...', 'projectify' ); ?></option>
                                                                    <?php if ( ! empty( $users_list ) )  { foreach ( $users_list as $key => $users ) { 
                                                                        $user = new WP_User( $users->ID );
                                                                            if ( ! in_array( 'btpjy_client', (array) $user->roles ) ) {
                                                                    ?>
                                                        ...
                                                        <!--begin::Group-->
                                                        <div class="form-group row fv-plugins-icon-container" id="user_name_div">
                                                            <label class="col-xl-3 col-lg-3 col-form-label"><?php esc_html_e( 'Username', 'projectify' ); ?></label>
                                                            <div class="col-lg-9 col-xl-9">
                                                                <input class="form-control form-control-solid form-control-lg" name="username" id="username" type="text" placeholder="<?php esc_attr_e( 'Enter member username', 'projectify' ); ?>">
                                                            <div class="fv-plugins-message-container"></div></div>
                                                        </div>
                                                        <!--end::Group-->
                                                        ...
                                                        <div class="form-group row fv-plugins-icon-container">
                                                            ...
                                                            <div class="col-lg-9 col-xl-9">
                                                                <input class="form-control form-control-solid form-control-lg" name="firstname" id="firstname" type="text" placeholder="<?php esc_attr_e( 'First Name', 'projectify' ); ?>">
                                                            <div class="fv-plugins-message-container"></div></div>
                                                        </div>
                                                        <!--end::Group-->
                                                        <!--begin::Group-->
                                                        <div class="form-group row fv-plugins-icon-container">
                                                            ...
                                                            <div class="col-lg-9 col-xl-9">
                                                                <input class="form-control form-control-solid form-control-lg" name="lastname" id="lastname" type="text" placeholder="<?php esc_attr_e( 'Last Name', 'projectify' ); ?>">
                                                            <div class="fv-plugins-message-container"></div></div>
                                                        </div>
                                                        <!--end::Group-->
                                                        <!--begin::Group-->
                                                        <div class="form-group row fv-plugins-icon-container">
                                                            ...
                                                            <div class="col-lg-9 col-xl-9">
                                                                <div class="input-group input-group-solid input-group-lg">
                                                                    ...
                                                                    <input type="text" class="form-control form-control-solid form-control-lg" id="phone" name="phone" placeholder="<?php esc_attr_e( 'Phone', 'projectify' ); ?>">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <!--end::Group-->
                                                        ...
                                                        <div class="form-group row fv-plugins-icon-container">
                                                            ...
                                                            <div class="col-lg-9 col-xl-9">
                                                                <div class="input-group input-group-solid input-group-lg">
                                                                    ...
                                                                    <input type="text" class="form-control form-control-solid form-control-lg" name="email" id="email" placeholder="<?php esc_attr_e( 'Your Email', 'projectify' ); ?>">
                                                                </div>
                                                            <div class="fv-plugins-message-container"></div></div>
                                                        </div>
                                                        <!--end::Group-->
                                                        ...
                                                        <div class="form-group row fv-plugins-icon-container">
                                                            ...
                                                            <div class="col-lg-9 col-xl-9">
                                                                <div class="input-group input-group-solid input-group-lg">
                                                                    ...
                                                                    <input type="text" class="form-control form-control-solid form-control-lg" name="facebook" placeholder="<?php esc_attr_e( 'Your FB ID like:- 100063975758895', 'projectify' ); ?>">
                                                                </div>
                                                            <div class="fv-plugins-message-container"></div></div>
                                                        </div>
                                                        <!--end::Group-->
                                                        ...
                                                        <div class="form-group row fv-plugins-icon-container">
                                                            ...
                                                            <div class="col-lg-9 col-xl-9">
                                                                <div class="input-group input-group-solid input-group-lg">
                                                                    ...
                                                                    <input type="text" class="form-control form-control-solid form-control-lg" name="skype" placeholder="<?php esc_attr_e( 'Your Skype ID like:- xiIh6C7CCziQ', 'projectify' ); ?>">
                                                                </div>
                                                            <div class="fv-plugins-message-container"></div></div>
                                                        </div>
                                                        <!--end::Group-->
                                                    ...
                                                    <div class="my-5 step" id="member-fields-panel-two" data-wizard-type="step-content" data-wizard-state="">
                                                        ...
                                                        <div class="form-group row fv-plugins-icon-container">
                                                            ...
                                                            <div class="col-lg-9 col-xl-9">
                                                                <input class="form-control form-control-solid form-control-lg" id="designation" name="designation" type="text" placeholder="<?php esc_attr_e( 'Designation', 'projectify' ); ?>">
                                                            <div class="fv-plugins-message-container"></div></div>
                                                        </div>
                                                        <!--begin::Group-->
                                                        <div class="form-group row fv-plugins-icon-container">
                                                            ...
                                                            <div class="col-xl-9 col-lg-9">
                                                                <select class="form-control form-control-lg form-control-solid" name="department">
                                                                    <option value=""><?php esc_html_e( 'Select Department...', 'projectify' ); ?></option>
                                                                    <?php
                                                                        if ( ! empty ( $departments ) ) {
                                                                        foreach ( $departments as $depart_key => $depart_value ) {
                                                                            if ( $depart_value->status == 'Active' ) {
                                                                    ?>
                                                                    <option value="<?php echo esc_attr( $depart_value->name ); ?>"><?php echo esc_html( $depart_value->name ); ?></option>
                                                                    <?php } } } ?>
                                                                </select>
                                                            <div class="fv-plugins-message-container"></div></div>
                                                        </div>
                                                        ...
                                                        <div class="form-group row fv-plugins-icon-container">
                                                            ...
                                                            <div class="col-xl-9 col-lg-9">
                                                                <select class="form-control form-control-lg form-control-solid" name="role">
                                                                    <option value="team-member"><?php esc_html_e( 'Team Member', 'projectify' ); ?></option>
                                                                    <option value="administrator"><?php esc_html_e( 'Adminstrator', 'projectify' ); ?></option>
                                                                    <option value="team-leader"><?php esc_html_e( 'Team Leader', 'projectify' ); ?></option>
                                                                </select>
                                                    ...
                                                    <div class="my-5 step" id="member-fields-panel-three" data-wizard-type="step-content" data-wizard-state="">
                                                        <h5 class="mb-10 font-weight-bold text-dark"><?php esc_html_e( 'Setup Address', 'projectify' ); ?></h5>
                                                        <!--begin::Group-->
                                                        <div class="form-group fv-plugins-icon-container">
                                                            <label><?php esc_html_e( 'Address Line 1', 'projectify' ); ?></label>
                                                            <input type="text" class="form-control form-control-solid form-control-lg" name="address1" placeholder="<?php esc_attr_e( 'Address Line 1', 'projectify' ); ?>">
                                                        <div class="fv-plugins-message-container"></div></div>
                                                        <!--end::Group-->
                                                        <!--begin::Group-->
                                                        <div class="form-group">
                                                            <label><?php esc_html_e( 'Address Line 2', 'projectify' ); ?></label>
                                                            <input type="text" class="form-control form-control-solid form-control-lg" name="address2" placeholder="<?php esc_attr_e( 'Address Line 2', 'projectify' ); ?>">
                                                        </div>
                                                        <!--begin::Row-->
                                                        <div class="row">
                                                            <div class="col-xl-6">
                                                                ...
                                                                <div class="form-group fv-plugins-icon-container">
                                                                    ...
                                                                    <input type="text" class="form-control form-control-solid form-control-lg" name="postcode" placeholder="<?php esc_attr_e( 'Enter Postcode', 'projectify' ); ?>">
                                                                <div class="fv-plugins-message-container"></div></div>
                                                            </div>
                                                            <!--end::Group-->
                                                            <!--begin::Group-->
                                                            <div class="col-xl-6">
                                                                <div class="form-group fv-plugins-icon-container">
                                                                    ...
                                                                    <input type="text" class="form-control form-control-solid form-control-lg" name="city" placeholder="<?php esc_attr_e( 'Enter City', 'projectify' ); ?>">
                                                                <div class="fv-plugins-message-container"></div></div>
                                                            </div>
                                                            <!--end::Group-->
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-xl-6">
                                                                ...
                                                                <div class="form-group fv-plugins-icon-container">
                                                                    ...
                                                                    <input type="text" class="form-control form-control-solid form-control-lg" name="state" placeholder="<?php esc_attr_e( 'Enter State', 'projectify' ); ?>">
                                                                <div class="fv-plugins-message-container"></div></div>
                                                                <!--end::Group-->
                                                            </div>
                                                            <div class="col-xl-6">
                                                                ...
                                                                <div class="form-group fv-plugins-icon-container">
                                                                    ...
                                                                    <input type="text" class="form-control form-control-solid form-control-lg" name="country" placeholder="<?php esc_attr_e( 'Enter Country', 'projectify' ); ?>">
                                                                <div class="fv-plugins-message-container"></div></div>
                                                                <!--end::Group-->
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="d-flex justify-content-between border-top pt-10 mt-15">
                                                            ...
                                                            <div>
                                                                <button type="button" id="next-step-three" class="btn btn-primary font-weight-bolder px-10 py-3" data-wizard-type="action-next" data-type="member"><?php esc_html_e( 'Next', 'projectify' ); ?> 
                                                                <span class="svg-icon svg-icon-md ml-3">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                                            <polygon points="0 0 24 0 24 24 0 24"></polygon>
                                                    ...
                                                    <div class="my-5 step" id="member-fields-panel-four" data-wizard-type="step-content" data-wizard-state="">
                                                        ...
                                                        <div class="border-bottom mb-5 pb-5">
                                                            <div class="font-weight-bolder mb-3"><?php esc_html_e( 'Member Account Details:', 'projectify' ); ?></div>
                                                            <div class="line-height-xl">
                                                                <?php esc_html_e( 'First name:- ', 'projectify' ); ?>
                                                                <span id="firstname-span"></span>
                                                                <br><?php esc_html_e( 'Last name:- ', 'projectify' ); ?>
                                                                <span id="lastname-span"></span>
                                                                <br><?php esc_html_e( 'Phone:- ', 'projectify' ); ?>
                                                                <span id="phone-span"></span>
                                                                <br><?php esc_html_e( 'Email:- ', 'projectify' ); ?>
                                                                <span id="email-span"></span>
                                                                <br><?php esc_html_e( 'Designation:- ', 'projectify' ); ?>
                                                                <span id="desig-span"></span>
                                                            </div>
                                                        </div>
                                                        <!--end::Item-->
                                                        <!--begin::Wizard Actions-->
                                                        <div class="d-flex justify-content-between border-top pt-10 mt-15">
                                                            ...
                                                            <div>
                                                                <button type="submit" class="btn btn-success font-weight-bolder px-10 py-3" id="AddMembersBtn"><?php esc_html_e( 'Submit', 'projectify' ); ?>
                                                                <span class="svg-icon svg-icon-md ml-3">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                                            <polygon points="0 0 24 0 24 24 0 24"></polygon>
