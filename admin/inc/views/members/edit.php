    ...
    <div class="subheader py-2 py-lg-6 subheader-transparent" id="btpjy_subheader">
        <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                <!--begin::Title-->
                <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5"><?php esc_html_e( 'Edit Member', 'projectify' ); ?></h5>
                <!--end::Title-->
                <!--begin::Separator-->
                ...
                <div class="d-flex align-items-center" id="btpjy_subheader_search">
                    <span class="text-dark-50 font-weight-bold" id="btpjy_subheader_total"><?php esc_html_e( 'Edit user details and submit', 'projectify' ); ?></span>
                </div>
                <!--end::Search Form-->
            </div>
            <!--end::Details-->
                                                ...
                                                <div class="col-xl-9">
                                                    ...
                                                    <div class="my-5 step" id="member-fields-panel-one" data-wizard-type="step-content" data-wizard-state="current">
                                                        ...
                                                        <div class="form-group row fv-plugins-icon-container">
                                                            ...
                                                            <div class="col-lg-9 col-xl-9">
                                                                <input class="form-control form-control-solid form-control-lg" id="firstname" name="firstname" type="text" placeholder="<?php esc_attr_e( 'First Name', 'projectify' ); ?>" value="<?php echo esc_html( btpjy_Helper::btpjy_value_check( $members->first_name ) ); ?>">
                                                        ...
                                                        <div class="form-group row fv-plugins-icon-container">
                                                            ...
                                                            <div class="col-lg-9 col-xl-9">
                                                                <input class="form-control form-control-solid form-control-lg" id="lastname" name="lastname" type="text" placeholder="<?php esc_attr_e( 'Last Name', 'projectify' ); ?>" value="<?php echo esc_html( btpjy_Helper::btpjy_value_check( $members->last_name ) ); ?>">
                                                            <div class="fv-plugins-message-container"></div></div>
                                                        </div>
                                                        <!--end::Group-->
                                                        <!--begin::Group-->
                                                        <div class="form-group row fv-plugins-icon-container">
                                                            ...
                                                            <div class="col-lg-9 col-xl-9">
                                                                <div class="input-group input-group-solid input-group-lg">
                                                                    ...
                                                                    <input type="text" class="form-control form-control-solid form-control-lg" id="phone" name="phone" placeholder="<?php esc_attr_e( 'Phone', 'projectify' ); ?>" value="<?php echo esc_html( btpjy_Helper::btpjy_value_check( $members->phone ) ); ?>">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <!--end::Group-->
                                                        ...
                                                        <div class="form-group row fv-plugins-icon-container">
                                                            ...
                                                            <div class="col-lg-9 col-xl-9">
                                                                <div class="input-group input-group-solid input-group-lg">
                                                                    ...
                                                                    <input type="text" class="form-control form-control-solid form-control-lg" id="email" name="email" placeholder="<?php esc_attr_e( 'Your Email', 'projectify' ); ?>" value="<?php echo esc_html( btpjy_Helper::btpjy_value_check( $members->email ) ); ?>">
                                                                </div>
                                                            <div class="fv-plugins-message-container"></div></div>
                                                        </div>
                                                        <!--end::Group-->
                                                    ...
                                                    <div class="my-5 step" id="member-fields-panel-two" data-wizard-type="step-content" data-wizard-state="">
                                                        ...
                                                        <div class="form-group row fv-plugins-icon-container">
                                                            ...
                                                            <div class="col-lg-9 col-xl-9">
                                                                <input class="form-control form-control-solid form-control-lg" id="designation" name="designation" type="text" placeholder="<?php esc_attr_e( 'Designation', 'projectify' ); ?>" value="<?php echo esc_html( btpjy_Helper::btpjy_value_check( $members->job_title ) ); ?>">
                                                            <div class="fv-plugins-message-container"></div></div>
                                                        </div>
                                                        <!--begin::Group-->
                                                        <div class="form-group row fv-plugins-icon-container">
                                                            ...
                                                            <div class="col-xl-9 col-lg-9">
                                                                <select class="form-control form-control-lg form-control-solid" name="department">
                                                                    ...
                                                                    ?>
                                                                    <option value="<?php echo esc_attr( $depart_value->name ); ?>" <?php selected( $members->department, $depart_value->name ); ?>><?php echo esc_html( $depart_value->name ); ?></option>
                                                                    <?php } } } ?>
                                                                </select>
                                                            <div class="fv-plugins-message-container"></div></div>
                                                        </div>
                                                        ...
                                                        <div class="form-group row fv-plugins-icon-container">
                                                            ...
                                                            <div class="col-xl-9 col-lg-9">
                                                                <select class="form-control form-control-lg form-control-solid" name="role">
                                                                    <option value="team-member" <?php selected( $members->role, 'team-member' ); ?>><?php esc_html_e( 'Team Member', 'projectify' ); ?></option>
                                                                    <option value="administrator" <?php selected( $members->role, 'administrator' ); ?>><?php esc_html_e( 'Adminstrator', 'projectify' ); ?></option>
                                                                    <option value="team-leader" <?php selected( $members->role, 'team-leader' ); ?>><?php esc_html_e( 'Team Leader', 'projectify' ); ?></option>
                                                                </select>
                                                        ...
                                                        <div class="form-group row fv-plugins-icon-container">
                                                            ...
                                                            <div class="col-xl-9 col-lg-9">
                                                                <select class="form-control form-control-lg form-control-solid" name="status">
                                                                    <option value="active" <?php selected( $members->status, 'active' ); ?>><?php esc_html_e( 'Active', 'projectify' ); ?></option>
                                                                    <option value="inactive" <?php selected( $members->status, 'inactive' ); ?>><?php esc_html_e( 'Inactive', 'projectify' ); ?></option>
                                                                </select>
                                                                <div class="fv-plugins-message-container"></div>
                                                            </div>
                                                        </div>
