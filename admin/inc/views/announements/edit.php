    ...
    <div class="subheader py-2 py-lg-6 subheader-transparent" id="btpjy_subheader">
        <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                <!--begin::Title-->
                <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5"><?php esc_html_e( 'Edit Announcement', 'projectify' ); ?></h5>
                <!--end::Title-->
                <!--begin::Separator-->
                ...
                <div class="d-flex align-items-center" id="btpjy_subheader_search">
                    <span class="text-dark-50 font-weight-bold" id="btpjy_subheader_total"><?php esc_html_e( 'Edit announement details and submit', 'projectify' ); ?></span>
                </div>
                <!--end::Search Form-->
            </div>
            <!--end::Details-->
                                ...
                                <div class="wizard-step" id="wizard-step-one" data-wizard-type="step" data-wizard-state="current">
                                    <div class="wizard-wrapper">
                                        ...
                                        <div class="wizard-label">
                                            ...
                                            <div class="wizard-desc"><?php esc_html_e( 'General Information', 'projectify' ); ?></div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card-body p-0">
                                <div class="row justify-content-center py-8 px-8 py-lg-15 px-lg-10">
                                    <div class="col-xl-12 col-xxl-10">
                                        <!--begin::Wizard Form-->
                                        <form class="form fv-plugins-bootstrap fv-plugins-framework" id="EditAnnouncementForm" method="post" action="<?php echo esc_url( admin_url( 'admin-ajax.php' ) ); ?>">
                                            <?php $nonce = wp_create_nonce( 'btpjy_edit_announces' ); ?>
                                            <input type="hidden" name="btpjy_edit_announces_nounce" value="<?php echo esc_attr( $nonce ); ?>">
                                            <input type="hidden" name="action" value="btpjy_edit_announces">
                                            <div class="row justify-content-center">
                                                <div class="col-xl-9">
                                                    <!--begin::Wizard Step 1-->
                                                    <div class="my-5 step" id="member-fields-panel-one" data-wizard-type="step-content" data-wizard-state="current">
                                                        <h5 class="text-dark font-weight-bold mb-10"><?php esc_html_e( 'Announcement Details:', 'projectify' ); ?></h5>
                                                        <!--begin::Group-->
                                                        <div class="form-group row fv-plugins-icon-container">
                                                            <label class="col-xl-3 col-lg-3 col-form-label"><?php esc_html_e( 'Title', 'projectify' ); ?></label>
                                                            <div class="col-lg-9 col-xl-9">
                                                                <input class="form-control form-control-solid form-control-lg" name="a_title" type="text" placeholder="<?php esc_attr_e( 'Enter title for announcement', 'projectify' ); ?>" value="<?php echo esc_attr( $announce->title ); ?>">
                                                            </div>
                                                        </div>
                                                        <!--end::Group-->
                                                        <!--begin::Group-->
                                                        <div class="form-group row fv-plugins-icon-container">
                                                            ...
                                                            <div class="col-lg-9 col-xl-9">
                                                                <textarea class="form-control form-control-solid form-control-lg" rows="5" name="a_desc">
                                                        ...
                                                        <div class="d-flex justify-content-between border-top pt-10 mt-15">
                                                            <div>
                                                                <button type="submit" class="btn btn-success font-weight-bolder px-10 py-3" id="EditAnnouncementBtn"><?php esc_html_e( 'Submit', 'projectify' ); ?>
