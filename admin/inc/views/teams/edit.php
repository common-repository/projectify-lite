...
$teams   = btpjy_Helper::btpjy_team_info( $row_id );
    ...
    <div class="subheader py-2 py-lg-6 subheader-transparent" id="btpjy_subheader">
        <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                <!--begin::Title-->
                <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5"><?php esc_html_e( 'Edit Team', 'projectify' ); ?></h5>
                <!--end::Title-->
                <!--begin::Separator-->
                ...
                <div class="d-flex align-items-center" id="btpjy_subheader_search">
                    <span class="text-dark-50 font-weight-bold" id="btpjy_subheader_total"><?php esc_html_e( 'Edit Team details and submit', 'projectify' ); ?></span>
                </div>
                <!--end::Search Form-->
            </div>
            <!--end::Details-->
                            ...
                            <div class="card-body p-0">
                                <div class="row justify-content-center py-8 px-8 py-lg-15 px-lg-10">
                                    <div class="col-xl-12 col-xxl-10">
                                        <!--begin::Wizard Form-->
                                        <form class="form fv-plugins-bootstrap fv-plugins-framework" id="EditTeamsForm" method="post" action="<?php echo esc_url( admin_url( 'admin-ajax.php' ) ); ?>">
                                            <?php $nonce = wp_create_nonce( 'btpjy_edit_teams' ); ?>
                                            <input type="hidden" name="btpjy_edit_teams_nounce" value="<?php echo esc_attr( $nonce ); ?>">
                                            <input type="hidden" name="action" value="btpjy_edit_teams_action">
                                                    ...
                                                    <div class="my-5 step" id="member-fields-panel-one" data-wizard-type="step-content" data-wizard-state="current">
                                                        ...
                                                        <div class="form-group row fv-plugins-icon-container">
                                                            ...
                                                            <div class="col-lg-9 col-xl-9">
                                                                <input class="form-control form-control-solid form-control-lg" placeholder="<?php esc_attr_e( 'Enter title for team' ); ?>" name="title" type="text" value="<?php echo esc_attr( btpjy_Helper::btpjy_value_check( $teams->name ) ); ?>">
                                                        ...
                                                        <div class="form-group row fv-plugins-icon-container">
                                                            ...
                                                            <div class="col-lg-9 col-xl-9">
                                                            <textarea class="form-control form-control-solid form-control-lg" name="description" placeholder="<?php esc_attr_e( 'Enter description for team' ); ?>"><?php echo esc_html( btpjy_Helper::btpjy_value_check( $teams->description ) ); ?></textarea>
                                                            <div class="fv-plugins-message-container"></div></div>
                                                        </div>
                                                        <!--end::Group-->
                                                        <!--begin::Group-->
                                                        <div class="form-group row fv-plugins-icon-container">
                                                            ...
                                                            <div class="col-xl-9 col-lg-9">
                                                                ...
                                                                <select class="form-control form-control-lg form-control-solid selectpicker" data-live-search="true" name="user_ids[]" multiple="multiple">
                                                                    ...
                                                                    ?>
                                                                       <option value="<?php echo esc_attr( $user->user_id ); ?>" <?php if ( in_array( $user->user_id, $members ) ) { echo esc_attr( 'selected' ); } ?>>
                                                            ...
                                                            <div class="col-xl-9 col-lg-9">
                                                                ...
                                                                <select class="form-control form-control-lg form-control-solid selectpicker" data-live-search="true" name="leader">
                                                                    ...
                                                                    if ( ! empty( $users_list ) )  { 
                                                                        foreach ( $users_list as $key => $user ) { 
                                                                    ?>
                                                                       <option value="<?php echo esc_attr( $user->user_id ); ?>" <?php selected( $teams->team_leader, $user->user_id ); ?>>
                                                                           <?php echo esc_html( $user->name ); ?>
                                                                       </option>
                                                                    <?php } } ?>
                                                                </select>
                                                        ...
                                                        <div class="form-group row fv-plugins-icon-container">
                                                            ...
                                                            <div class="col-xl-9 col-lg-9">
                                                                <select class="form-control form-control-lg form-control-solid" name="status">
                                                                    <option value="active" <?php selected( $teams->status, 'active' ); ?>><?php esc_html_e( 'Active', 'projectify' ); ?></option>
                                                                    <option value="inactive" <?php selected( $teams->status, 'inactive' ); ?>><?php esc_html_e( 'Inactive', 'projectify' ); ?></option>
                                                                </select>
                                                        ...
                                                        <div class="d-flex justify-content-between border-top pt-10 mt-15">
                                                            <div>
                                                                <button type="submit" class="btn btn-success font-weight-bolder px-10 py-3" id="EditTeamsBtn"><?php esc_html_e( 'Submit', 'projectify' ); ?>
