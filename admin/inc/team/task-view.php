                            ...
                            <div class="subtask-inner-details">
                                ...
                                <span id="ms_start_72-1">
                                    <a href="<?php echo esc_url( 
                                            ...
                                            ), admin_url( 'admin.php?page=projectify-pro-member-projects' ) ) ); ?>" class="navi-link text-dark">
                                ...
                                <div class="timeline-items">
                                    ...
                                    <div class="timeline-item">
                                        ...
                                        <div class="timeline-desc timeline-desc-light-primary h-100">
                                            ...
                                            <span class="font-weight-bolder"><?php echo esc_html( btpjy_Helper::btpjy_get_formated_date( $cvalue->date ) ).', '.esc_html( btpjy_Helper::btpjy_get_formated_time( $cvalue->time ) ); ?></span>
